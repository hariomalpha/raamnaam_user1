...
const String issuerName = 'Ramnam';

//General Error Message
const String errorMesaage = 'Something went wrong, Error : ';

//Bank detail hint text
const String bankDetail = 'Bank Details:\nAccount No :123XXXXX\nIFSC Code: 123XXX \nName: Abc xyz';

//Api class instance
ApiBaseHelper apiBaseHelper = ApiBaseHelper();

// for demo panels
const String baseUrl = 'https://alphawizzserver.com/raamnaam/api/';
